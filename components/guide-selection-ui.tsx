  ...
  const guides: Guide[] = [
    {
      ...
      rating: 4.9,
      reviewCount: 142,
      languages: ["이탈리아어", "한국어", "영어"],
      specialties: ["고대 로마 유적", "바티칸", "음식 투어"],
      experience: "7년",
      price: "1일 €140",
      availability: "6월 10일~30일",
      description:
        "로마에서 7년간 현지 가이드로 활동 중인 마르코입니다. 콜로세움, 포럼 로마눔 등 고대 로마 유적 전문가이며, 바티칸 박물관 공인 가이드입니다.",
      verified: true,
    },
    {
      id: 2,
