...
import { User, Star, DollarSign, Calendar, Settings, Bell, Globe, Shield, Edit } from "lucide-react"

export default function GuideSettingsUI() {
  // 가이드 프로필 정보 수정
  const guideProfile = {
    name: "소피(김소희)",
  ...
  return (
    <div className="flex flex-col h-full overflow-auto">
      <div className="p-4 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="p-4 bg-green-50 rounded-lg">
              <div className="text-sm text-green-600 mb-1">이번 달 수익</div>
              <div className="text-2xl font-bold text-green-800">€2,450</div>
            </div>
            <div className="p-4 bg-blue-50 rounded-lg">
              <div className="text-sm text-blue-600 mb-1">총 누적 수익</div>
              <div className="text-2xl font-bold text-blue-800">€18,750</div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border">
          <h3 className="font-bold text-gray-800 text-lg mb-4 flex items-center">
            <Settings className="h-5 w-5 mr-2" />앱 설정
          </h3>
